...
export default function CardTabelaCobrancas() {
    const {
        todasCobrancas, setTodasCobrancas,
        ...
        parametroSlice, setParametroSlice,
        setDadosCobranca,
        setTodosClientes,
    ...
    function ordenarClientes() {
        const arrayDeCobrancas = [...todasCobrancas];
        ...
        setTodasCobrancas(arrayDeCobrancasOrdenado);
    }
    ...
    return (
        <>
            <div className='container-card_tabela-cobrancas'>
                ...
                {todasCobrancas && todasCobrancas.slice(parametroSlice, parametroSlice + 10).map(cobranca => (
                    <div
                ...
                <div
                    ...
                    <div className='paginacao-cobrancas-direita'
                        onClick={() => {
                            if (parametroSlice + 10 >= todasCobrancas.length) return;
                            setParametroSlice(parametroSlice + 10);
                        }}>
                        <h1>{'>>>>'}</h1>
                    </div>
