...
export default function CardTabelaClientes() {
    const {
        ...
        setAtualCliente,
        parametroSlice, setParametroSlice,  token
    } = useGlobal();
    ...
    function ordenarClientes() {
        const arrayDeClientes = [...todosClientes];
        ...
        setTodosClientes(arrayDeClientesOrdenado);
    };
    ...
    return (
        <div className='container-tabela-clientes'>
            ...
            {todosClientes && todosClientes.slice(parametroSlice, parametroSlice + 10).map(cliente => (
